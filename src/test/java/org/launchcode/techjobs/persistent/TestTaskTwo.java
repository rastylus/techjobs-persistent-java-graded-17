    ...
    * */
    ...
    public void testEmployerRepositoryDefinition () throws ClassNotFoundException {
        ...
        assertEquals(EmployerRepository.class, employerRepositoryField.getType(),
                "employerRepository must be of type EmployerRepository");
...
//     * */
    ...
    public void testSkillRepositoryDefinition () throws ClassNotFoundException {
        ...
        assertEquals(SkillRepository.class, skillRepositoryField.getType(), "skillRepository must" +
                " be of type SkillRepository");
